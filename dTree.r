...
dataSet = read.csv("B Valuation.csv")
...
MyTree <- rpart(Success ~ Previous + Consulting + Teacher + Employment + Head + Google + Microsoft + Sales + StanorBerk + Ivy, data=trainingSet, method="class", 
              control=rpart.control(minsplit = 1, cp=0.00000000001))
